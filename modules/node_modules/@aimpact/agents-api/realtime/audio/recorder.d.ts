...
declare namespace ns_3 {
  ...
  export const permissions: {
    "__#141826@#ready": PendingPromise<void>;
    readonly ready: PendingPromise<void>;
    "__#141826@#permission"?: PermissionStatus;
    "__#141826@#state": IPermissionState;
    readonly state: IPermissionState;
    "__#141826@#error": Error;
    readonly error: Error;
    "__#141826@#set"(state: IPermissionState): void;
    /**
     * Not available in Safari
     */
    "__#141826@#onchange"(status: PermissionStatus): void;
    request(): Promise<void>;
    release(): void;
    "__#112937@#private": any;

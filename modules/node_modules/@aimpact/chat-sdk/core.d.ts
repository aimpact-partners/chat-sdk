...
import * as __beyond_dep_ns_1 from '@beyond-js/reactive/entities/collection';
import * as __beyond_dep_ns_2 from '@beyond-js/reactive/entities/item';
import * as __beyond_dep_ns_3 from '@beyond-js/http-suite/api';
...
declare namespace ns_4 {
  ...
  import IChatUsage = ns_2.IChatUsage;
  import ICreateChatOptions = ns_2.ICreateChatOptions;
  export class Chat extends Item<IChat> {
    ...
    load: (specs: any) => Promise<void>;
    getData(): Partial<IChat>;
    sendMessage(content: string): Promise<Message>;
    retry(id: any): Promise<void>;
    ...
    create(options?: ICreateChatOptions): Promise<void>;
    /**
     ...
     * ```
     */
    static create(options?: ICreateChatOptions): Promise<Chat>;
  }
}
